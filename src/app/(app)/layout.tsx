    ...
    <div className="flex flex-col h-screen">
      ...
      <header className="hidden md:flex bg-white border-b border-gray-200 h-12 items-center px-5 shrink-0 z-40">
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 bg-cyan-600 rounded-sm grid grid-cols-2 gap-px p-0.5 shrink-0">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50">
          {/* Mobile top bar */}
          <header className="md:hidden sticky top-0 z-40 bg-white border-b-2 border-cyan-500">
